...
public class JSONParser {
	...
	public static Object parse(String input) {
		...
		System.err.println("Index is now " + context.index);
		return result;
	}
	...
	public static Object newParse(Context context) {
		...
		case '9':
			...
			if (hasE) {
				...
				BigDecimal exponent = new BigDecimal(Math.pow(10,
...
// figured out that you need "instanceof Boolean" instead of "instanceof boolean" for unparser